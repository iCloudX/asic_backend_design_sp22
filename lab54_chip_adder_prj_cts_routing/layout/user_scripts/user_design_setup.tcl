...
set TOP_MODULE                  "pad_TOP"
set ICC_IN_VERILOG_NETLIST_FILE "./user_data/pad_TOP_gate.v"
set FUNC1_SDC         "./user_data/adder_top.pnr.sdc"
set FUNCCTS_SDC       "./user_data/adder_top.pnr_cts.sdc"
set FUNC_CHIP_FINISH_SDC       "./user_data/adder_top.pnr_chip_finish.sdc"
set ICC_IN_IO_CONST_FILE          "./tdf/pad_TOP.tdf"
