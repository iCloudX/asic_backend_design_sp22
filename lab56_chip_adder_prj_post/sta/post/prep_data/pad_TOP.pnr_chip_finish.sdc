...
#set_max_area 0
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[0]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[1]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[2]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[3]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[4]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[5]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[6]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[7]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[8]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[9]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[10]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[11]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[12]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[13]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[14]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {a_in[15]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[0]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[1]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[2]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[3]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[4]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[5]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[6]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[7]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[8]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[9]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[10]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[11]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[12]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[13]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[14]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports {b_in[15]}]
set_driving_cell -lib_cell PHTIC -library hgi1113tp1_wci [get_ports carry_in]
...
#{sum_out[4]}] [get_ports {sum_out[3]}] [get_ports {sum_out[2]}] [get_ports     \
#{sum_out[1]}] [get_ports {sum_out[0]}] [get_ports carry_out]]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[15]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[15]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[14]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[14]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[13]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[13]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[12]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[12]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[11]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[11]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[10]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[10]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[9]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[9]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[8]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[8]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[7]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[7]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[6]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[6]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[5]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[5]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[4]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[4]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[3]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[3]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[2]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[2]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[1]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[1]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {a_in[0]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {a_in[0]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[15]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[15]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[14]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[14]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[13]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[13]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[12]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[12]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[11]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[11]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[10]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[10]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[9]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[9]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[8]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[8]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[7]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[7]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[6]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[6]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[5]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[5]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[4]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[4]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[3]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[3]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[2]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[2]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[1]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[1]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {b_in[0]}]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports {b_in[0]}]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports carry_in]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports carry_in]
set_input_delay -clock MAIN_CLOCK  -max 1.5  [get_ports rst_n]
set_input_delay -clock MAIN_CLOCK  -min 1  [get_ports rst_n]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[15]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[15]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[14]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[14]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[13]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[13]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[12]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[12]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[11]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[11]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[10]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[10]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[9]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[9]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[8]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[8]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[7]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[7]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[6]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[6]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[5]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[5]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[4]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[4]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[3]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[3]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[2]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[2]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[1]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[1]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports {sum_out[0]}]
set_output_delay -clock MAIN_CLOCK  -min -0.5  [get_ports {sum_out[0]}]
set_output_delay -clock MAIN_CLOCK  -max 1.5  [get_ports carry_out]
