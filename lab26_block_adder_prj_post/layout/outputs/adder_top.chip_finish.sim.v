...
// Generated on 05/16/2022 at 13:55:18
...
// Cell Name    :adder_top
// Hierarchy delimiter:'/'
// Write Command : write_verilog ./outputs/adder_top.chip_finish.sim.v -no_corner_pad_cells -no_pad_filler_cells  
...
DFFRHQX1 sum_out_reg_7_ (.CK ( clk ) , .D ( sum[7] ) , .RN ( IN0 ) 
    , .Q ( sum_out[7] ) ) ;
DFFRHQX1 sum_out_reg_8_ (.CK ( clk_cts_2 ) , .D ( sum[8] ) , .RN ( IN1 ) 
    , .Q ( sum_out[8] ) ) ;
DFFRHQX1 sum_out_reg_9_ (.CK ( clk_cts_2 ) , .D ( sum[9] ) , .RN ( IN1 ) 
    , .Q ( sum_out[9] ) ) ;
DFFRHQX1 sum_out_reg_10_ (.CK ( clk_cts_2 ) , .D ( sum[10] ) , .RN ( IN1 ) 
    , .Q ( sum_out[10] ) ) ;
DFFRHQX1 sum_out_reg_11_ (.CK ( clk_cts_2 ) , .D ( sum[11] ) , .RN ( rst_n ) 
    , .Q ( sum_out[11] ) ) ;
DFFRHQX1 sum_out_reg_12_ (.CK ( clk ) , .D ( sum[12] ) , .RN ( rst_n ) 
    , .Q ( sum_out[12] ) ) ;
DFFRHQX1 sum_out_reg_13_ (.CK ( clk ) , .D ( sum[13] ) , .RN ( rst_n ) 
    , .Q ( sum_out[13] ) ) ;
...
DFFRHQX1 carry_out_reg (.CK ( clk_cts_1 ) , .D ( carry_gen[3] ) , .RN ( rst_n ) 
    , .Q ( carry_out ) ) ;
DFFRHQX1 sum_out_reg_0_ (.CK ( clk_cts_2 ) , .D ( sum[0] ) , .RN ( IN0 ) 
    , .Q ( sum_out[0] ) ) ;
...
DFFRHQX1 sum_out_reg_10_ (.CK ( clk_cts_0 ) , .D ( sum[10] ) , .RN ( IN1 ) 
    , .Q ( sum_out[10] ) ) ;
DFFRHQX1 sum_out_reg_11_ (.CK ( clk_cts_4 ) , .D ( sum[11] ) , .RN ( IN1 ) 
    , .Q ( sum_out[11] ) ) ;
DFFRHQX1 sum_out_reg_12_ (.CK ( clk_cts_4 ) , .D ( sum[12] ) , .RN ( IN0 ) 
    , .Q ( sum_out[12] ) ) ;
DFFRHQX1 sum_out_reg_13_ (.CK ( clk_cts_4 ) , .D ( sum[13] ) , .RN ( rst_n ) 
    , .Q ( sum_out[13] ) ) ;
DFFRHQX1 sum_out_reg_14_ (.CK ( clk ) , .D ( sum[14] ) , .RN ( rst_n ) 
    , .Q ( sum_out[14] ) ) ;
DFFRHQX1 carry_out_reg (.CK ( clk_cts_4 ) , .D ( carry[15] ) , .RN ( IN0 ) 
    , .Q ( carry_out ) ) ;
...
carry_lookahead_adder_16_0 u2_cla16 (.clk ( clk_G1B2I3 ) , .rst_n ( rst_n ) , 
    .carry_in ( cla_carry_out ) , .carry_out ( n34 ) , .IN0 ( n2 ) , 
    .clk_cts_1 ( clk_G1B2I2 ) , 
    .sum_out ( {n18 , n19 , n20 , n21 , n22 , n23 , n24 , n25 , n26 , n27 , 
	n28 , n29 , n30 , n31 , n32 , n33 } ) , 
    .b_in ( b_reg_d2 ) , .a_in ( cla_sum ) ) ;


carry_lookahead_adder_16_1 u1_cla16 (.clk ( clk_G1B2I3 ) , .rst_n ( rst_n ) , 
    .carry_in ( rca_carry_w ) , .carry_out ( cla_carry_out ) , .IN0 ( n2 ) , 
    .IN1 ( n1 ) , .sum_out ( cla_sum ) , .b_in ( a_reg_d ) , .a_in ( rca_sum_w ) , 
    .clk_cts_1 ( clk_G1B2I2 ) , .clk_cts_2 ( clk_G1B2I1 ) ) ;


ripple_carry_adder_16 u_rca16 (.clk ( clk_G1B2I2 ) , .rst_n ( rst_n ) , 
    .carry_in ( c_in_reg ) , .carry_out ( rca_carry_w ) , .IN0 ( n2 ) , 
    .IN1 ( n1 ) , .sum_out ( rca_sum_w ) , .b_in ( b_reg ) , .a_in ( a_reg ) , 
    .clk_cts_0 ( clk_G1B2I5 ) , .clk_cts_1 ( clk_G1B2I4 ) , 
    .clk_cts_2 ( clk_G1B2I3 ) , .clk_cts_4 ( clk_G1B2I1 ) ) ;

INVX8 CLKINVX8_G1B1I1 (.A ( clk_G1B1I1 ) , .Y ( clk_G1B2I1 ) ) ;
INVX8 CLKINVX8_G1B2I1 (.A ( clk ) , .Y ( clk_G1B1I1 ) ) ;
CLKINVX8 CLKINVX8_G1B1I5 (.A ( clk_G1B1I1 ) , .Y ( clk_G1B2I5 ) ) ;
CLKINVX8 CLKINVX8_G1B1I4 (.A ( clk_G1B1I1 ) , .Y ( clk_G1B2I4 ) ) ;
CLKINVX8 CLKINVX8_G1B1I3 (.A ( clk_G1B1I1 ) , .Y ( clk_G1B2I3 ) ) ;
CLKINVX8 CLKINVX8_G1B1I2 (.A ( clk_G1B1I1 ) , .Y ( clk_G1B2I2 ) ) ;
BUFX1 U1 (.A ( rst_n ) , .Y ( n1 ) ) ;
BUFX1 U2 (.A ( rst_n ) , .Y ( n2 ) ) ;
DFFRHQX1 a_reg_d_reg_7_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[7] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[7] ) ) ;
DFFRHQX1 a_reg_d_reg_6_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[6] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[6] ) ) ;
DFFRHQX1 a_reg_d_reg_5_ (.CK ( clk_G1B2I3 ) , .D ( a_reg[5] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[5] ) ) ;
DFFRHQX1 a_reg_d_reg_4_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[4] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[4] ) ) ;
DFFRHQX1 a_reg_d_reg_3_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[3] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[3] ) ) ;
DFFRHQX1 a_reg_d_reg_2_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[2] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[2] ) ) ;
DFFRHQX1 a_reg_d_reg_1_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[1] ) , .RN ( n1 ) 
    , .Q ( a_reg_d[1] ) ) ;
DFFRHQX1 a_reg_d_reg_0_ (.CK ( clk_G1B2I4 ) , .D ( a_reg[0] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[0] ) ) ;
DFFRHQX1 b_reg_d_reg_15_ (.CK ( clk_G1B2I2 ) , .D ( b_reg[15] ) , .RN ( rst_n ) 
    , .Q ( b_reg_d[15] ) ) ;
DFFRHQX1 b_reg_d_reg_14_ (.CK ( clk_G1B2I2 ) , .D ( b_reg[14] ) , .RN ( rst_n ) 
    , .Q ( b_reg_d[14] ) ) ;
DFFRHQX1 b_reg_d_reg_13_ (.CK ( clk_G1B2I2 ) , .D ( b_reg[13] ) , .RN ( rst_n ) 
    , .Q ( b_reg_d[13] ) ) ;
DFFRHQX1 b_reg_d_reg_12_ (.CK ( clk_G1B2I3 ) , .D ( b_reg[12] ) , .RN ( n2 ) 
    , .Q ( b_reg_d[12] ) ) ;
DFFRHQX1 b_reg_d_reg_11_ (.CK ( clk_G1B2I1 ) , .D ( b_reg[11] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[11] ) ) ;
DFFRHQX1 b_reg_d_reg_10_ (.CK ( clk_G1B2I5 ) , .D ( b_reg[10] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[10] ) ) ;
DFFRHQX1 b_reg_d_reg_9_ (.CK ( clk_G1B2I5 ) , .D ( b_reg[9] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[9] ) ) ;
DFFRHQX1 b_reg_d_reg_8_ (.CK ( clk_G1B2I5 ) , .D ( b_reg[8] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[8] ) ) ;
DFFRHQX1 b_reg_d_reg_7_ (.CK ( clk_G1B2I4 ) , .D ( b_reg[7] ) , .RN ( n2 ) 
    , .Q ( b_reg_d[7] ) ) ;
DFFRHQX1 b_reg_d_reg_6_ (.CK ( clk_G1B2I3 ) , .D ( b_reg[6] ) , .RN ( n2 ) 
    , .Q ( b_reg_d[6] ) ) ;
DFFRHQX1 b_reg_d_reg_5_ (.CK ( clk_G1B2I3 ) , .D ( b_reg[5] ) , .RN ( n2 ) 
    , .Q ( b_reg_d[5] ) ) ;
DFFRHQX1 b_reg_d_reg_4_ (.CK ( clk_G1B2I3 ) , .D ( b_reg[4] ) , .RN ( n2 ) 
    , .Q ( b_reg_d[4] ) ) ;
DFFRHQX1 b_reg_d_reg_3_ (.CK ( clk_G1B2I4 ) , .D ( b_reg[3] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[3] ) ) ;
DFFRHQX1 b_reg_d_reg_2_ (.CK ( clk_G1B2I4 ) , .D ( b_reg[2] ) , .RN ( n2 ) 
    , .Q ( b_reg_d[2] ) ) ;
DFFRHQX1 b_reg_d_reg_1_ (.CK ( clk_G1B2I4 ) , .D ( b_reg[1] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[1] ) ) ;
DFFRHQX1 b_reg_d_reg_0_ (.CK ( clk_G1B2I5 ) , .D ( b_reg[0] ) , .RN ( n1 ) 
    , .Q ( b_reg_d[0] ) ) ;
DFFRHQX1 b_reg_d2_reg_15_ (.CK ( clk_G1B2I2 ) , .D ( b_reg_d[15] ) 
    , .RN ( rst_n ) , .Q ( b_reg_d2[15] ) ) ;
DFFRHQX1 b_reg_d2_reg_14_ (.CK ( clk_G1B2I2 ) , .D ( b_reg_d[14] ) 
    , .RN ( rst_n ) , .Q ( b_reg_d2[14] ) ) ;
DFFRHQX1 b_reg_d2_reg_13_ (.CK ( clk_G1B2I2 ) , .D ( b_reg_d[13] ) 
    , .RN ( rst_n ) , .Q ( b_reg_d2[13] ) ) ;
DFFRHQX1 b_reg_d2_reg_12_ (.CK ( clk_G1B2I3 ) , .D ( b_reg_d[12] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[12] ) ) ;
DFFRHQX1 b_reg_d2_reg_11_ (.CK ( clk_G1B2I1 ) , .D ( b_reg_d[11] ) , .RN ( n1 ) 
    , .Q ( b_reg_d2[11] ) ) ;
DFFRHQX1 b_reg_d2_reg_10_ (.CK ( clk_G1B2I1 ) , .D ( b_reg_d[10] ) , .RN ( n1 ) 
    , .Q ( b_reg_d2[10] ) ) ;
DFFRHQX1 b_reg_d2_reg_9_ (.CK ( clk_G1B2I5 ) , .D ( b_reg_d[9] ) , .RN ( n1 ) 
    , .Q ( b_reg_d2[9] ) ) ;
DFFRHQX1 b_reg_d2_reg_8_ (.CK ( clk_G1B2I5 ) , .D ( b_reg_d[8] ) , .RN ( n1 ) 
    , .Q ( b_reg_d2[8] ) ) ;
DFFRHQX1 b_reg_d2_reg_7_ (.CK ( clk_G1B2I3 ) , .D ( b_reg_d[7] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[7] ) ) ;
DFFRHQX1 b_reg_d2_reg_6_ (.CK ( clk_G1B2I3 ) , .D ( b_reg_d[6] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[6] ) ) ;
DFFRHQX1 b_reg_d2_reg_5_ (.CK ( clk_G1B2I3 ) , .D ( b_reg_d[5] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[5] ) ) ;
DFFRHQX1 b_reg_d2_reg_4_ (.CK ( clk_G1B2I3 ) , .D ( b_reg_d[4] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[4] ) ) ;
DFFRHQX1 b_reg_d2_reg_3_ (.CK ( clk_G1B2I1 ) , .D ( b_reg_d[3] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[3] ) ) ;
DFFRHQX1 b_reg_d2_reg_2_ (.CK ( clk_G1B2I3 ) , .D ( b_reg_d[2] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[2] ) ) ;
DFFRHQX1 b_reg_d2_reg_1_ (.CK ( clk_G1B2I1 ) , .D ( b_reg_d[1] ) , .RN ( n2 ) 
    , .Q ( b_reg_d2[1] ) ) ;
DFFRHQX1 b_reg_d2_reg_0_ (.CK ( clk_G1B2I1 ) , .D ( b_reg_d[0] ) , .RN ( n1 ) 
    , .Q ( b_reg_d2[0] ) ) ;
...
DFFRHQX1 b_reg_reg_15_ (.CK ( clk_G1B2I2 ) , .D ( b_in[15] ) , .RN ( rst_n ) 
    , .Q ( b_reg[15] ) ) ;
DFFRHQX1 b_reg_reg_14_ (.CK ( clk_G1B2I1 ) , .D ( b_in[14] ) , .RN ( n1 ) 
    , .Q ( b_reg[14] ) ) ;
DFFRHQX1 b_reg_reg_13_ (.CK ( clk_G1B2I1 ) , .D ( b_in[13] ) , .RN ( n1 ) 
    , .Q ( b_reg[13] ) ) ;
DFFRHQX1 b_reg_reg_12_ (.CK ( clk_G1B2I5 ) , .D ( b_in[12] ) , .RN ( n1 ) 
    , .Q ( b_reg[12] ) ) ;
DFFRHQX1 b_reg_reg_11_ (.CK ( clk_G1B2I5 ) , .D ( b_in[11] ) , .RN ( n1 ) 
    , .Q ( b_reg[11] ) ) ;
DFFRHQX1 b_reg_reg_10_ (.CK ( clk_G1B2I5 ) , .D ( b_in[10] ) , .RN ( n1 ) 
    , .Q ( b_reg[10] ) ) ;
DFFRHQX1 b_reg_reg_9_ (.CK ( clk_G1B2I5 ) , .D ( b_in[9] ) , .RN ( n1 ) 
    , .Q ( b_reg[9] ) ) ;
DFFRHQX1 b_reg_reg_8_ (.CK ( clk_G1B2I5 ) , .D ( b_in[8] ) , .RN ( n1 ) 
    , .Q ( b_reg[8] ) ) ;
DFFRHQX1 b_reg_reg_7_ (.CK ( clk_G1B2I5 ) , .D ( b_in[7] ) , .RN ( n1 ) 
    , .Q ( b_reg[7] ) ) ;
DFFRHQX1 b_reg_reg_6_ (.CK ( clk_G1B2I5 ) , .D ( b_in[6] ) , .RN ( n1 ) 
    , .Q ( b_reg[6] ) ) ;
DFFRHQX1 b_reg_reg_5_ (.CK ( clk_G1B2I5 ) , .D ( b_in[5] ) , .RN ( n1 ) 
    , .Q ( b_reg[5] ) ) ;
DFFRHQX1 b_reg_reg_4_ (.CK ( clk_G1B2I5 ) , .D ( b_in[4] ) , .RN ( n1 ) 
    , .Q ( b_reg[4] ) ) ;
DFFRHQX1 b_reg_reg_3_ (.CK ( clk_G1B2I5 ) , .D ( b_in[3] ) , .RN ( n1 ) 
    , .Q ( b_reg[3] ) ) ;
DFFRHQX1 b_reg_reg_2_ (.CK ( clk_G1B2I5 ) , .D ( b_in[2] ) , .RN ( n1 ) 
    , .Q ( b_reg[2] ) ) ;
DFFRHQX1 b_reg_reg_1_ (.CK ( clk_G1B2I5 ) , .D ( b_in[1] ) , .RN ( n1 ) 
    , .Q ( b_reg[1] ) ) ;
DFFRHQX1 b_reg_reg_0_ (.CK ( clk_G1B2I5 ) , .D ( b_in[0] ) , .RN ( n1 ) 
    , .Q ( b_reg[0] ) ) ;
DFFRHQX1 c_in_reg_reg (.CK ( clk_G1B2I4 ) , .D ( carry_in ) , .RN ( n1 ) 
    , .Q ( c_in_reg ) ) ;
DFFRHQX1 a_reg_reg_15_ (.CK ( clk_G1B2I3 ) , .D ( a_in[15] ) , .RN ( n2 ) 
    , .Q ( a_reg[15] ) ) ;
DFFRHQX1 a_reg_reg_14_ (.CK ( clk_G1B2I3 ) , .D ( a_in[14] ) , .RN ( n2 ) 
    , .Q ( a_reg[14] ) ) ;
DFFRHQX1 a_reg_reg_13_ (.CK ( clk_G1B2I4 ) , .D ( a_in[13] ) , .RN ( n2 ) 
    , .Q ( a_reg[13] ) ) ;
DFFRHQX1 a_reg_reg_12_ (.CK ( clk_G1B2I4 ) , .D ( a_in[12] ) , .RN ( n2 ) 
    , .Q ( a_reg[12] ) ) ;
DFFRHQX1 a_reg_reg_11_ (.CK ( clk_G1B2I4 ) , .D ( a_in[11] ) , .RN ( n2 ) 
    , .Q ( a_reg[11] ) ) ;
DFFRHQX1 a_reg_reg_10_ (.CK ( clk_G1B2I4 ) , .D ( a_in[10] ) , .RN ( n2 ) 
    , .Q ( a_reg[10] ) ) ;
DFFRHQX1 a_reg_reg_9_ (.CK ( clk_G1B2I4 ) , .D ( a_in[9] ) , .RN ( n2 ) 
    , .Q ( a_reg[9] ) ) ;
DFFRHQX1 a_reg_reg_8_ (.CK ( clk_G1B2I5 ) , .D ( a_in[8] ) , .RN ( n1 ) 
    , .Q ( a_reg[8] ) ) ;
DFFRHQX1 a_reg_reg_7_ (.CK ( clk_G1B2I4 ) , .D ( a_in[7] ) , .RN ( n2 ) 
    , .Q ( a_reg[7] ) ) ;
DFFRHQX1 a_reg_reg_6_ (.CK ( clk_G1B2I4 ) , .D ( a_in[6] ) , .RN ( n2 ) 
    , .Q ( a_reg[6] ) ) ;
DFFRHQX1 a_reg_reg_5_ (.CK ( clk_G1B2I4 ) , .D ( a_in[5] ) , .RN ( n2 ) 
    , .Q ( a_reg[5] ) ) ;
DFFRHQX1 a_reg_reg_4_ (.CK ( clk_G1B2I4 ) , .D ( a_in[4] ) , .RN ( n2 ) 
    , .Q ( a_reg[4] ) ) ;
DFFRHQX1 a_reg_reg_3_ (.CK ( clk_G1B2I4 ) , .D ( a_in[3] ) , .RN ( n2 ) 
    , .Q ( a_reg[3] ) ) ;
DFFRHQX1 a_reg_reg_2_ (.CK ( clk_G1B2I4 ) , .D ( a_in[2] ) , .RN ( n2 ) 
    , .Q ( a_reg[2] ) ) ;
DFFRHQX1 a_reg_reg_1_ (.CK ( clk_G1B2I4 ) , .D ( a_in[1] ) , .RN ( n2 ) 
    , .Q ( a_reg[1] ) ) ;
DFFRHQX1 a_reg_reg_0_ (.CK ( clk_G1B2I4 ) , .D ( a_in[0] ) , .RN ( n2 ) 
    , .Q ( a_reg[0] ) ) ;
DFFRHQX1 a_reg_d_reg_15_ (.CK ( clk_G1B2I3 ) , .D ( a_reg[15] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[15] ) ) ;
DFFRHQX1 a_reg_d_reg_14_ (.CK ( clk_G1B2I1 ) , .D ( a_reg[14] ) , .RN ( rst_n ) 
    , .Q ( a_reg_d[14] ) ) ;
DFFRHQX1 a_reg_d_reg_13_ (.CK ( clk_G1B2I1 ) , .D ( a_reg[13] ) , .RN ( rst_n ) 
    , .Q ( a_reg_d[13] ) ) ;
DFFRHQX1 a_reg_d_reg_12_ (.CK ( clk_G1B2I1 ) , .D ( a_reg[12] ) , .RN ( n2 ) 
    , .Q ( a_reg_d[12] ) ) ;
DFFRHQX1 a_reg_d_reg_11_ (.CK ( clk_G1B2I1 ) , .D ( a_reg[11] ) , .RN ( n1 ) 
    , .Q ( a_reg_d[11] ) ) ;
DFFRHQX1 a_reg_d_reg_10_ (.CK ( clk_G1B2I5 ) , .D ( a_reg[10] ) , .RN ( n1 ) 
    , .Q ( a_reg_d[10] ) ) ;
DFFRHQX1 a_reg_d_reg_9_ (.CK ( clk_G1B2I5 ) , .D ( a_reg[9] ) , .RN ( n1 ) 
    , .Q ( a_reg_d[9] ) ) ;
DFFRHQX1 a_reg_d_reg_8_ (.CK ( clk_G1B2I5 ) , .D ( a_reg[8] ) , .RN ( n1 ) 
    , .Q ( a_reg_d[8] ) ) ;
endmodule
