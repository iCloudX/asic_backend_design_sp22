...
## source the common_setup & Common variables file
    source -echo -v ./icc_scripts/user_design_setup.tcl
...
#	commit_fp_rail
   ...
   create_power_straps  -direction horizontal  -start_at 200 -num_placement_strap 8 -increment_x_or_y 40 -nets  {VDD VSS}  -layer MET5 -width 2

   create_power_straps  -direction vertical  -start_at 200 -num_placement_strap 8 -increment_x_or_y 40 -nets  {VDD VSS}  -layer MET4 -width 2
